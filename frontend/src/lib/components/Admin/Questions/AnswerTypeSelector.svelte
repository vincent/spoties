...
<div class={divClass}>
  <Button outline={!!value} class="flex w-full justify-between">
    {value
      ? $t(`event.form.question_type_${value}` as any)
      : $t(`event.form.question_type`)}<ChevronDownOutline
  ...
  >
    ...
    <DropdownItem class="flex items-center justify-between">
      <UserPenIcon class="mr-2" size="16" />
      {$t(`event.form.personal_data`)}
      <ChevronRightOutline
        class="text-primary-700 ms-2 ml-auto h-6 w-6 dark:text-white"
      />
    </DropdownItem>
    ...
    <DropdownItem class="flex items-center justify-between">
      <AlignJustify class="mr-2" size="16" />
      {$t(`event.form.text`)}
      <ChevronRightOutline
        class="text-primary-700 ms-2 ml-auto h-6 w-6 dark:text-white"
      />
    ...
    <Dropdown simple placement="right-start">
      ...
      <AnswerTypeSelectorItem
        {select}
        key="rich_text"
        helper={"Write a long formatted text"}
      >
    ...
    <DropdownItem class="flex items-center justify-between">
      <ListTodoIcon class="mr-2" size="16" />
      {$t(`event.form.choice`)}
      <ChevronRightOutline
        class="text-primary-700 ms-2 ml-auto h-6 w-6 dark:text-white"
      />
    ...
    <Dropdown simple placement="right-start">
      ...
      <AnswerTypeSelectorItem
        {select}
        key="select_one"
        helper={`Choose one option among multiple values`}
      >
        <CheckIcon class="mx-2" size="16" />
      </AnswerTypeSelectorItem>
      <AnswerTypeSelectorItem
        {select}
        key="select_many"
        helper={`Choose one or more options among multiple selectable values`}
      >
      ...
      <AnswerTypeSelectorItem
        {select}
        key="checkboxes"
        helper={`Choose one or more options among multiple visible values`}
      >
    ...
    <AnswerTypeSelectorItem
      {select}
      key="range"
      helper={`Choose a value in a range`}
    >
