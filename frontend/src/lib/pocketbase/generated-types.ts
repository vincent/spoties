...
export type AdminsResponse<Texpand = unknown> = Required<AdminsRecord> &
  AuthSystemFields<Texpand>;
export type AnswersResponse<Tvalue = unknown, Texpand = unknown> = Required<
  AnswersRecord<Tvalue>
> &
  BaseSystemFields<Texpand>;
export type BookingsResponse<Texpand = unknown> = Required<BookingsRecord> &
  BaseSystemFields<Texpand>;
...
export type LocationsResponse<Texpand = unknown> = Required<LocationsRecord> &
  BaseSystemFields<Texpand>;
export type ParticipantsResponse<Texpand = unknown> =
  Required<ParticipantsRecord> & BaseSystemFields<Texpand>;
export type PostsResponse<Texpand = unknown> = Required<PostsRecord> &
  BaseSystemFields<Texpand>;
export type QuestionsResponse<
  Tproperties = unknown,
  Texpand = unknown,
> = Required<QuestionsRecord<Tproperties>> & BaseSystemFields<Texpand>;
export type TeamsResponse<Texpand = unknown> = Required<TeamsRecord> &
  BaseSystemFields<Texpand>;
export type TimeSlotsResponse<Texpand = unknown> = Required<TimeSlotsRecord> &
  BaseSystemFields<Texpand>;
