<script lang="ts">
  ...
  data.metadata.title = data.config.site?.name;
...
<section class="bg-white dark:bg-gray-900 xl:mt-10">
  <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
    <div class="mr-auto place-self-center lg:col-span-7">
      <h1 class="max-w-2xl mb-4 text-3xl font-extrabold tracking-tight leading-none md:text-4xl xl:text-5xl dark:text-white whitespace-pre-wrap">{@html data.metadata.headline}</h1>
      <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">{@html data.metadata.subline}</p>
    ...
    <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
      <img src="/connect-people.svg" alt="mockup">
    </div>                
  </div>
</section>