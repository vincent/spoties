...
migrate((app) => {
  ...
  unmarshal({
    "listRule": "@request.auth.id != '' && @collection.participants.event != ''",
    "viewRule": "@request.auth.id != '' && @collection.participants.event != ''"
  }, collection)
  ...
  // remove field
  collection.fields.removeById("_clone_FZUm")

  // remove field
  collection.fields.removeById("_clone_6T9X")

  // remove field
  collection.fields.removeById("_clone_Llsz")

  // remove field
  collection.fields.removeById("_clone_N69c")
