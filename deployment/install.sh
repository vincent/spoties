...
sed -i "s%serve --dev%serve --dir $POCKETBASE_DATADIR --hooksDir $POCKETBASE_HOOKSDIR --migrationsDir $POCKETBASE_MIGRATIONSDIR %" $PROJECT_DIR/next/backend/modd.conf # use % to escape '/'' chars
